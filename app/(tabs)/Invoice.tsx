...
const InvoiceScreen: React.FC = () => {
  const invoiceData = {
    ...
    cashier: 'Sachin',
    items: [
      { name: 'Water Bottle', qty: 1, rate: 20.0 },
      { name: 'Samosa', qty: 2, rate: 30.0 },
      { name: 'Jalebi', qty: 1, rate: 15.0 },
      { name: 'Pakoda', qty: 2, rate: 10.0 },
      { name: 'Special Tea', qty: 4, rate: 30.0 },
      { name: 'Coffee', qty: 2, rate: 40.0 },
    ],
  };
